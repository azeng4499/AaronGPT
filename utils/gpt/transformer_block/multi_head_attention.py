...
class MultiHeadAttention(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        keys = keys.view(batch, seq_length, self.num_heads, self.head_dim)
        values = values.view(batch, seq_length, self.num_heads, self.head_dim)
        queries = queries.view(batch, seq_length, self.num_heads, self.head_dim)
